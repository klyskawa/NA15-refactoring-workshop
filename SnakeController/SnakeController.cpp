...
void Controller::receive(std::unique_ptr<Event> e)
{
        ...
        {
            case TimeoutInd::MESSAGE_ID: if(!paused) {handleTimePassed(*static_cast<EventT<TimeoutInd> const&>(*e));} return;
            case DirectionInd::MESSAGE_ID: if(!paused) {handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e));} return;
